    ...
    <div>
        ...
        <div className="max-w-screen flex flex-wrap items-center justify-between mx-auto p-4 pl-10 pr-10">
          ...
          <div className="hidden w-full md:block md:w-auto" id="navbar-default">
            <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-default rounded-base bg-neutral-secondary-soft md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-neutral-primary">
              ...
              <li>
                <a href="http://localhost:3000/login" className="block py-2 px-3 text-neutral-400 rounded hover:bg-neutral-tertiary md:hover:bg-transparent md:border-0 md:hover:text-fg-brand md:p-0 md:dark:hover:bg-transparent">Login</a>
              </li>
              <li>
                <a href="http://localhost:3000/register" className="block py-2 px-3 text-white rounded hover:bg-neutral-tertiary md:hover:bg-transparent md:border-0 md:hover:text-fg-brand md:p-0 md:dark:hover:bg-transparent">Register</a>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div className="grid w-full max-w-md items-start gap-4 m-10 mt-20">
        <Alert>
          ...
          <AlertDescription>
            You've logged in successfully. Soon you'll be redirected to another page.
          </AlertDescription>
        </Alert>
      </div>
      <div>
        <Card className="w-120 max-w-200 m-auto mt-50">
          <CardHeader>
            ...
            <CardAction>
              <Button variant="link"><a href="http://localhost:3000/register">Sign Up</a></Button>
            </CardAction>
          </CardHeader>
          <CardContent>
            <form>
